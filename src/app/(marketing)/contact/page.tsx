  ...
  return (
    <>
      <PageHero
        ...
        description="Tell us what you need and we'll reply within one working day with an initial proposal."
        meta={
        ...
        <div className="mx-auto max-w-[1640px] px-5 md:px-8 lg:px-12">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10">
            {offices.map((o) => (
              ...
              >
                <p className="font-mono text-[0.65rem] uppercase tracking-[0.22em] text-brand-accent">
                  {o.region}
                </p>
